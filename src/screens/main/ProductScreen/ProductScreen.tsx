...
const ProductScreen = () => {
  ...
  const bestSellingProducts: Product[] = [
    {
      id: '1',
      title: 'ARC 12000BTU Inverter',
      groupname: 'Điều hòa',
      imgurl: 'https://via.placeholder.com/200x200/FFFFFF/E31E24?text=ARC+12K',
      priceformat: '8.500.000đ',
      originalpriceformat: '10.000.000đ',
    },
    {
      id: '2',
      title: 'ARC 18000BTU Inverter',
      groupname: 'Điều hòa',
      imgurl: 'https://via.placeholder.com/200x200/FFFFFF/E31E24?text=ARC+18K',
    ...
    },
    {
      ...
      title: 'ARC 9000BTU',
      groupname: 'Điều hòa',
      imgurl: 'https://via.placeholder.com/200x200/FFFFFF/E31E24?text=ARC+9K',
  ...
  const newProducts: Product[] = [
    {
      id: '4',
      title: 'ARC 24000BTU Inverter',
      groupname: 'Điều hòa',
      imgurl: 'https://via.placeholder.com/200x200/FFFFFF/E31E24?text=ARC+24K',
      priceformat: '15.500.000đ',
      originalpriceformat: '17.000.000đ',
    },
    {
      id: '5',
      title: 'Máy nước nóng ARC 20L',
